...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href="student_dashboard.php"><?=$fname;?> <?=$lname;?></a>
          <a class="navbar-brand brand-logo-mini" href="student_dashboard.php"><?=$fname;?> <?=$lname;?></a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="cocurricular.php">
              <i class="mdi mdi-format-float-left menu-icon"></i>
              <span class="menu-title">Add Co-curricular Event Details</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="extracurricular.php">
              <i class="mdi mdi-format-float-left menu-icon"></i>
              <span class="menu-title">Add Extra Curricular Event Details</span>
            </a>
          </li>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Extra Curricular Events Details</p>
	...
	while($ExtraCuEvent = $ExtraCuEvents->fetch_assoc()):?>
                        <tr>
			    <td>
                  		<a href="Edit_extracurricular.php?event_id=<?=$ExtraCuEvent['event_id'];?>"><i class="fas fa-edit">Edit</i></a>
               		    </td>
                	     <td>
                  		<a href="delete_extracurricular.php?event_id=<?=$ExtraCuEvent['event_id'];?>"><i class="fas fa-trash">Delete</i></a>
               		    </td>
         ...
         <div class="content-wrapper"> 
          ...
          <div class="row">
			...
			while($CoEvent= $CoEvents->fetch_assoc()):?>
                        <tr>
			                <td>
                  		<a href="Edit_cocurricular.php?eventid=<?=$CoEvent['eventid'];?>"><i class="fas fa-edit">Edit</i></a>
               		    </td>
                	     <td>
                  		<a href="delete_cocurricular.php?eventid=<?=$CoEvent['eventid'];?>"><i class="fas fa-trash">Delete</i></a>
               		    </td>
