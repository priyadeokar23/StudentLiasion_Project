...
if(isset($_POST['confirm'])){
   ...
   $result = mysqli_query($connect,$query);
	...
	$_SESSION['email'] = $email;
		 ...
		 echo "<script>window.open('change_password2.php','_self')</script>";
...
<br>
<button class="bt button1" onclick="window.location.href='login_admin.php';">Back</button>
...
<div class="form_wrapper">
  <div class="form_container">
    ...
    <div class="row clearfix">
      <div class="">
        <form action="getmail2.php" method="POST">
