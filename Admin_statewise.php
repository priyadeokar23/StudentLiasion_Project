      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body" >
                <h4 class="card-title">StateWise Search</h4>
                <form class="form-inline" >
                  <label class="menu-title" for="inlineFormInputGroupUsername2">State wise </label>
          ...
          <form action="download_code\export_statewise_cocurricular.php" method="POST">
          <div class="row">
		...
		<div class="content-wrapper">
         ...
         <form action="download_code\export_statewise_extracurricular.php" method="POST">
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
