      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body" >
                <h4 class="card-title">Cocurricular event Search</h4>
                <form class="form-inline" >
                  <label class="menu-title" for="inlineFormInputGroupUsername2">Cocurricular Event wise </label>
                    ...
                    <table id="recent-purchases-listing" class="table">
                      ...
                      <tbody>
						...
						if(isset($_GET['submit']))
						{
							...
							$sql1 = "SELECT * FROM cocurricular WHERE event_type LIKE '%".$event_type."%' ORDER BY cno;";
