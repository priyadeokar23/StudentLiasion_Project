      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body" >
                <h4 class="card-title">College Search</h4>
          ...
          <form action="download_code\export_collegewise_cocurricular.php" method="POST">
          <div class="row">
                    ...
                    <table id="recent-purchases-listing" class="table">
                      ...
                      <tbody>
						...
						if(isset($_GET['submit']))
						{
							...
							$sql1 = "SELECT * FROM cocurricular WHERE college LIKE '%".$college."%' ORDER BY cno;";
		...
		<div class="content-wrapper">
         ...
         <form action="download_code\export_collegewise_extracurricular.php" method="POST">
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">extra curricular CoEvent Details</p>
				  <div class="align-items-end ">
                    <button type="submit" name="download_con" class="btn btn-primary mt-2 mt-xl-0" style="margin-right: 50px;">Download report</button>
                  </div>
		          <div class="table-responsive">
					   ...
					   if(isset($_GET['submit']))
						{
							...
							$sql1 = "SELECT * FROM extracurricular WHERE college LIKE '%".$college."%' ORDER BY cno;";
