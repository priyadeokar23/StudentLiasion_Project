      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body" >
                <h4 class="card-title">Winner Wise Search</h4>
                <form class="form-inline" >
                  <label class="menu-title" for="inlineFormInputGroupUsername2">College wise </label>
                  <div class="input-group mb-2 mr-sm-2">
                    <select name="participation_status" class="form-control">
          ...
          <form action="download_code\export_winnerwise_cocurricular.php" method="POST">
          <div class="row">
				  ...
				  <div class="align-items-end ">
                    ...
                    <table id="recent-purchases-listing" class="table">
                      ...
                      <tbody>
						...
						{
							$participation_status = $_GET['participation_status'];
								
							$sql1 = "SELECT * FROM cocurricular WHERE participation_status LIKE '%".$participation_status."%' ORDER BY cno;";
		...
		<div class="content-wrapper">
         ...
         <form action="download_code\export_winnerwise_extracurricular.php" method="POST">
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
					   ...
					   if(isset($_GET['submit']))
						{
							...
							$sql1 = "SELECT * FROM extracurricular WHERE participation_status LIKE '%".$participation_status."%' ORDER BY cno;";
						...
						<?php endwhile;}}
						$_SESSION['participation_status'] = $participation_status;
						?>
                      </tbody>
                    </table>
                  </div>
